...
export default class Coinbasepro extends Bus {
  ...
  constructor() {
    super();
    this._ajax      = null;
    this._apiurl    = 'https://api.exchange.coinbase.com/';
    this._wssurl    = 'wss://ws-feed.exchange.coinbase.com';
    this._apikey    = '';    // API key
    this._apisecret = '';    // API secret
  ...
  fetchMarketsData() {
    ...
    const remote = `${this._apiurl}/products`;
    const local  = `../../../../public/market/json/exchangeInfo.json`;
