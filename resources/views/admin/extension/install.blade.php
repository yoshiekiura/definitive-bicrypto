...
<div class="col-6 card text-center mx-auto">
    <div class="card-body">
        <h1 class="card-title">Extension Installer</h1><br>
        <div class="box">
            ...
            <div class="alert alert-success mb-1">
                ...
                @endphp
                @else
                <form id="updater" action="{{ route('admin.extensions.install',[$product->product_id]) }}" method="POST">
                    @csrf
...
@push('breadcrumb-plugins')
    ...
    <a class="btn btn-primary" href="{{ route('admin.extensions.index') }}"><i class="bi bi-chevron-left"></i> {{ __('locale.Back')}}</a>
@endpush
