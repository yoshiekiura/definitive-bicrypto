                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="input-group mb-1">
                        <input type="name" class="form-control" id="name" name="name"
                            aria-describedby="name" value="{{ $network->name }}">
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-12">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="form-check form-switch d-inline-block">
                            <input type="checkbox" class="form-check-input" @if($network->status == 1) checked @endif data-bs-toggle="toggle" name="status" id="status" style="cursor: pointer;">
