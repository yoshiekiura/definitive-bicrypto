                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border-primary">
                                            ...
                                            <div class="card-body">
                                                <label class="mt-1 h6">{{ __('locale.Fixed Charge')}} <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <div class="input-group-text">{{ __($general->cur_text) }}</div>
                                                    <input type="text" class="form-control" placeholder="0"
                                                ...
                                                <label class="mt-1 h6">{{ __('locale.Percent Charge')}} <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-dark my-2">
                                            ...
                                            <div class="card-body">
                                                <div class="col mt-1">
                                                    <textarea rows="5" class="form-control rounded"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-dark">
                                            ...
                                            <h5 class="card-header bg-dark text-white">{{ __('locale.User data')}}
                                                <button type="button"
                                                            ...
                                                            <div class="input-group mb-md-0 mb-4">
                                                                ...
                                                                <div class="col-md-3 mt-md-0 mt-2">
                                                                    <select name="type[]" class="form-control">
                                                                        <option value="text" @if($v->type == 'text')
                                                                            selected @endif>
                                                                            {{ __('locale.Input Text')}}
                                                                        </option>
                                                                        <option value="textarea" @if($v->type ==
                                                                            'textarea') selected @endif>
                                                                            {{ __('locale.Textarea')}}
                                                                        </option>
                                                                        <option value="file" @if($v->type == 'file')
                                                                            selected @endif>
                                                                            {{ __('locale.File upload')}}
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-md-3 mt-md-0 mt-2">
                                                                    <select name="validation[]" class="form-control">
                                                                        <option value="required" @if($v->validation ==
                                                                            'required') selected @endif>
                                                                            {{ __('locale.Required')}} </option>
                                                                        <option value="nullable" @if($v->validation ==
                                                                            'nullable') selected @endif>
                                                                            {{ __('locale.Optional')}} </option>
                                                                    </select>
                                                                </div>
