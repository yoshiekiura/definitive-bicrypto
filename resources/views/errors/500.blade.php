    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-7 text-center">
          <img src="{{ asset('assets/errors/images/error-500.png') }}" alt="{{ __('locale.image')}}">
          <h2 class="title"><b>500</b> {{ __('locale.Internal Server Error')}}</h2>
          <p>{{ __('locale.The server has been deserted for a while.')}}</p>
          <p>{{ __('locale.Please be patient or try again later.')}}</p>
