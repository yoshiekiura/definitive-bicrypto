        ...
        <div class="row justify-content-between">
            <div class="col-lg-3 col-md-6 wow fadeInDown" data-wow-duration="0.3s" data-wow-delay="0.3s">
                <div class="footer-box">
                    ...
                    <p class="text">{{ $sections[4]->content->text1 }}</p>
                </div>
            </div>
            <div class="col-xl-8">
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="0.4s"
                        ...
                        <div class="footer-box">
                            ...
                            <ul class="footer-link">
                                <li><a href="{{ $sections[4]->content->aboutUslink }}">About Us</a></li>
                                <li><a href="{{ $sections[4]->content->contactUslink }}">Contact Us</a></li>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="0.5s"
                        ...
                        <div class="footer-box">
                            ...
                            <ul class="footer-link">
                                ...
                                <li><a href="{{ $sections[4]->content->knowledgeBaselink }}">Knowledge Base</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="0.6s"
                        ...
                        <div class="footer-box">
                            ...
                            <ul class="footer-link">
                                <li><a href="{{ $sections[4]->content->termslink }}">Terms of use</a></li>
                                <li><a href="{{ $sections[4]->content->privacylink }}">Privacy Policy</a></li>
                                <li><a href="{{ $sections[4]->content->refundlink }}">Refund Policy</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInDown" data-wow-duration="0.7s"
                        ...
                        <div class="footer-box">
                            ...
                            <ul class="footer-link">
                                <li> {{ $sections[4]->content->email }} </li>
                                <li> {{ $sections[4]->content->phone1 }} </li>
                                <li> {{ $sections[4]->content->phone2 }} </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 text-center">
                <div class="footer-bottom">
                    ...
                    <div class="social-style wow fadeInDown" data-wow-duration="0.4s" data-wow-delay="0.5s">
                        <a href="{{ $sections[4]->content->facebook }}"><i class="fab fa-facebook-f"></i></a>
                        <a href="{{ $sections[4]->content->twitter }}"><i class="fab fa-twitter"></i></a>
                        <a href="{{ $sections[4]->content->pinterest }}"><i class="fab fa-pinterest-p"></i></a>
                        <a href="{{ $sections[4]->content->instagram }}"><i class="fab fa-instagram"></i></a>
                    </div>
                </div>
            </div>
        </div>
