                    ...
                    <div class="tab-pane fade show active" id="pills-market" role="tabpanel"
                        aria-labelledby="pills-market-tab">
                            <div class="row pb-1 px-1">
                                <div class="col-6">
                                    <form id="Order">
                                        ...
                                        <div class="input-group input-group-sm mb-1">
                                            <input type="number" class="form-control text-dark border-0" min="{{ $limit->min_time_sec }}"
                                            max="{{ $limit->max_time_sec }}" required="" id="time" name="time" placeholder="Time">
                                            <button class="btn btn-outline-secondary dropdown-toggle text-dark border-0" type="button"
                                            data-bs-toggle="dropdown" aria-expanded="false" id="timed">Sec</button>
                                            <ul class="dropdown-menu dropdown-menu-end" id="timer">
                                                <li><a id="sec" name="sec" value="sec" min="{{ $limit->min_time_sec }}" max="{{ $limit->max_time_sec }}" href="javascript:void(0)" class="dropdown-item">Sec</a></li>
                                                <li><a id="min" name="min" value="min" min="{{ $limit->min_time_min }}" max="{{ $limit->max_time_min }}" href="javascript:void(0)" class="dropdown-item">Min</a></li>
                                                <li><a id="hour" name="hour" value="hour" min="{{ $limit->min_time_hour }}" max="{{ $limit->max_time_hour }}" href="javascript:void(0)" class="dropdown-item">Hour</a></li>
                                            </ul>
                                        </div>
                                        <label for="basic-url"
                                            class="form-label mb-1 d-flex justify-content-between text-1 text-dark">
                                        ...
                                        <div class="input-group input-group-sm mb-1">
                                            <input type="number" class="form-control text-dark border-0"  min="{{ $limit->min_amount }}" max="{{ $limit->max_amount }}"  step="0.00000001" required="" id="amount"
                                            name="amount" id="amount" placeholder="Amount" aria-label="Amount (to the nearest dollar)">
                                            <span class="input-group-text text-dark border-0">{{ $currency }}</span>
                                        </div>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="d-grid mt-1">
                                                    <button class="btn btn-success btn-sm RiseBtn" type="submit"><i class="bi bi-graph-up"></i> Rise</button>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="d-grid mt-1">
                                                    <button class="btn btn-danger btn-sm FallBtn" type="submit"><i class="bi bi-graph-down"></i> Fall</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="col-6">
                                    @livewire('binary.trade.balance', ['symbol' => $symbol, 'currency' => $currency])
                                </div>
                            </div>
                    </div>
            ...
            <div class="bordered-t darked px-0 ordercard hidden">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <div><span class="text-warning">Order Type: </span><span class="trade-user-type"></span></div>
                            <div><span class="text-warning">Price Was: </span><span class="trade-user-price"></span></div>
                        </div>
                    </div>
                </div>
                <div id="Chart"></div>
                ...
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    <div class="table-responsive">
                        <table class="table text-dark table-sm table-borderless">
                            ...
                            @livewire('binary.trade.open-orders', ['symbol' => $symbol,'currency' => $currency])
                        </table>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <div class="table-responsive">
                        <table class="table text-dark table-sm table-borderless">
                            ...
                            @livewire('binary.trade.order-history', ['symbol' => $symbol,'currency' => $currency])
                        </table>
                    </div>
                </div>
            </div>
...
<script src="https://code.highcharts.com/modules/accessibility.js"></script>
    <script>
        "use strict";
        let ws = new WebSocket('wss://stream.binance.com:9443/ws/{{strtolower($symbol)}}{{strtolower($currency)}}@depth20@100ms');
                            ...
                            success: function (response) {
                                if (response.value == 1) {
                                    ...
                                    if (OrderType == 1) {
                                        ...
                                        $(".trade-user-price").text(response.trade + " " + "{{ $currency }}");
