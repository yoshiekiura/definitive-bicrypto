...
<div class="content-area card">
        <div class="card-innr">
            <div class="card-head d-flex justify-content-between align-items-center">
                <h4 class="card-title mb-1">KYC Application Documents</h4>
                    <div class="d-flex align-items-center guttar-20px">
                        <div class="flex-col d-sm-block d-none">
                            <a href="{{ route('user.kyc') }}" class="btn btn-light btn-sm btn-auto btn-primary"><i class="bi bi-chevron-left mr-3"></i> Back</a>
                        </div>
                        <div class="flex-col d-sm-none">
                            <a href="{{ route('user.kyc') }}" class="btn btn-icon btn-sm btn-primary"><i class="bi bi-arrow-left"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="data-details d-md-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="fake-class">
                        ...
                        <span class="data-details-info text-dark">Not reviewed yet</span>
                    </div>
                    @endif
                ...
                <ul class="data-details-list">
                    ...
                    <li>
                        ...
                        <div class="data-details-des text-dark">{{ $kyc->address1 }}, {{ $kyc->address2 }}, {{ $kyc->city }}, {{ $kyc->state }} {{ $kyc->zip }}.</div>
                    </li>{{-- li --}}
                    <li>
                    ...
                    <li>
                        ...
                        <div class="data-details-des text-dark"><span{{ '@'.preg_replace('/@/', '', $kyc->telegram, 1) }} </span><a href="https://t.me/{{preg_replace('/@/', '', $kyc->telegram, 1)}}" target="_blank"><em class="far fa-paper-plane"></em></a></div>
                    </li>{{-- li --}}
                </ul>
                ...
                <ul class="data-details-list">
                    <li>
                        ...
                        <ul class="data-details-docs">
                            @if($kyc->document != NULL)
                            <li>
                                <span class="data-details-docs-title text-dark">{{ $kyc->documentType == 'nidcard' ? 'Front Side' : 'Document' }}</span>
                            ...
                            <li>
                                <span class="data-details-docs-title text-dark">{{ $kyc->documentType == 'nidcard' ? 'Back Side' : 'Proof' }}</span>
                                <div class="data-doc-item data-doc-item-lg">
                                    <div class="data-doc-image">
                            ...
                            <li>
                                <span class="data-details-docs-title text-dark">Proof</span>
                                <div class="data-doc-item data-doc-item-lg">
                                    <div class="data-doc-image">
